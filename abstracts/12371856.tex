...
\index[authors]{Kornak, John} \index[authors]{Boylan, Ross} \index[authors]{Young, Karl} \index[authors]{Wolf, Amy} \index[authors]{Cobigo, Yann} \index[authors]{Rosen, Howard}
...
\keywords{Bayesian image analysis, data-driven priors, Fourier space.}
